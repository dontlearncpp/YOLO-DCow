...
def train(cfg=DEFAULT_CFG, use_python=False):
    model =  '/media/xingshixu/367a0adf-4bec-4c64-b23d-945aacb28ba5/yangyolo/ultralytics-maincowfull/ultralytics/models/v8/seg/yolov8n-seg.yaml'
    data = '/media/xingshixu/367a0adf-4bec-4c64-b23d-945aacb28ba5/yangyolo/ultralytics-maincowfull/ultralytics/datasets/coco128-seg.yaml'  # or yolo.ClassificationDataset("mnist")
