...
class SegmentationTrainer(v8.detect.DetectionTrainer):
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        model = SegmentationModel(cfg, ch=4, nc=self.data['nc'], verbose=verbose and RANK == -1)#input channnel
        if weights:
            model.load(weights)
...
def train(cfg=DEFAULT_CFG, use_python=False):
    # model = cfg.model or '/media/xingshixu/367a0adf-4bec-4c64-b23d-945aacb28ba5/yangyolo/ultralytics-mainrgbd/ultralytics/models/v8/seg/yolov8n-seg.yaml'
    model =  '/media/xingshixu/367a0adf-4bec-4c64-b23d-945aacb28ba5/yangyolo/ultralytics-mainrgbd-cowfull-wiseiou-ffm-near-wu/ultralytics/models/v8/seg/yolov8n-seg.yaml'
    data = cfg.data or '/media/xingshixu/367a0adf-4bec-4c64-b23d-945aacb28ba5/yangyolo/ultralytics-mainrgbd-cowfull-wiseiou-ffm-near-wu/ultralytics/datasets/coco128-seg.yaml'  # or yolo.ClassificationDataset("mnist")
