...
class SegmentationModel(DetectionModel):
    ...
    def __init__(self, cfg='/media/xingshixu/367a0adf-4bec-4c64-b23d-945aacb28ba5/yangyolo/ultralytics-mainrgbd/ultralytics/models/v8/seg/yolov8n-seg.yaml', ch=4, nc=None, verbose=True):
